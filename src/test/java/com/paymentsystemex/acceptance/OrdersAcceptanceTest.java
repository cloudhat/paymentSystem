...
public class OrdersAcceptanceTest extends AcceptanceTest {
    ...
    public void setGivenData() {
        ...
        ProductOption productOption1 = new ProductOption(0, null, product1, "L 사이즈", PRODUCT1_PRICE, 10, LocalDateTime.now().minusDays(1), LocalDateTime.now().plusDays(1));
        ProductOption productOption2 = new ProductOption(0, null, product1, "M 사이즈", PRODUCT2_PRICE, 10, LocalDateTime.now().minusDays(1), LocalDateTime.now().plusDays(1));
